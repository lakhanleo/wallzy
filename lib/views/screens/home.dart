    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Padding(
          ...
          child: Text("Wallzy",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w700,fontFamily: "Outfit"),),
        ),
      ),
      body: Padding(
        ...
        child: Column(
          children: [
            // verticalSpace(30),
            CarouselSlider.builder(itemCount: WallpaperImageList.length,
